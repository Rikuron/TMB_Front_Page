...
const GenericNewsCard = ({ news, headlineSize = "text-xl" }: GenericNewsCardProps) => {
  return (
    <div id="side-news-card-container" className="w-full h-auto bg-white p-4 rounded-lg hover:scale-105 hover:shadow-[0_0_8px_2px_rgba(0,0,0,0.2)] hover:rounded-lg hover:cursor-pointer transition duration-500 ease-in-out">
      <a href="#">
