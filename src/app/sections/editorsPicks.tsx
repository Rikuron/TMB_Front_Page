  ...
  return (
    <div id="editors-picks">
      <div className="flex items-center space-x-2 mb-2 pl-1">
        <span className="w-[3.5px] h-[40px] bg-custom-yellow inline-block" />
        <p className="text-4xl align-middle font-nubernext font-bold text-black hover:text-custom-yellow hover:cursor-pointer transition duration-700 ease-in-out">Editor's Picks</p>
      </div>
