...
import TopNewsCard from "../components/Front Page components/News Section/topNewsCard"
import SideNewsCard from "../components/Front Page components/News Section/sideNewsCard"
import MoreStoriesCard from "../components/Front Page components/News Section/moreStoriesCard"
        ...
        <div className="main-news-container flex items-center justify-between w-[72.5%]">
          ...
          <div className="w-[39%] side-news-card-container">
            {sampleArticles.slice(1, 3).map((article) => (
              <SideNewsCard key={article.id} news={article} />
            ))}
          </div>
        </div>
